...
def main():
	...
	# Define network
	model =  Img_Graph_Multi_Graph_Net(input_dim=opt.input_dim, embedding_dim=opt.embedding_dim, img_feat_dim=opt.img_feat_dim, num_classes=opt.num_classes).to(device)
	print(model)
